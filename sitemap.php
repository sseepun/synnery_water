    ...
    <div class="container">
      ...
      $menu = [
        'เกี่ยวกับกรม' => [
          ...
          ['title' => 'หน้าที่ความรับผิดชอบ', 'link' => '#', 'new_tab' => false],
        ...
        'รายงานประจำปี' => [
          ...
          ['title' => 'กระบวนการบริหารงบประมาณ', 'link' => '#', 'new_tab' => false],
          ['title' => 'งบประมาณรายจ่ายประจำปี', 'link' => '#', 'new_tab' => false],
          ['title' => 'รายงานการเบิกจ่ายกรมงบประมาณ', 'link' => '#', 'new_tab' => false],
              ...
              <ul class="sitemap-list">
                <?php foreach ($value as $item) : ?>
                  <li>
                    ...
                    <a href="<?= $item['link'] ?>" <?= $item['new_tab'] ? 'target="_blank"' : '' ?>>
                      <?= $item['title'] ?>
                    </a>
                  </li>
                <?php endforeach; ?>
