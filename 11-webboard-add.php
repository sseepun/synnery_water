              ...
              <div class="grids">
                <div class="grid sm-100">
                  ...
                  <div class="form-input">
                    <input class="validate-error" type="text" placeholder="กรุณาระบุหัวข้อ">
                  </div>
                ...
                <div class="grid sm-100 mt-5">
                  ...
                  <div class="form-input">
                    <select class="ui dropdown validate-error">
                      <option value="0">กรุณาระบุหมวดหมู่กระทู้</option>
                    </select>
                ...
                <div class="grid sm-100 mt-5">
                  ...
                  <p class="xs message-error text-danger mt-1 pl-4">กรุณาระบุรายละเอียด</p>
                </div>
                <div class="grid sm-100 mt-5">
