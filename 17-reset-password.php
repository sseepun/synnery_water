...
<body class="loading">
    ...
    <div class="container">
      ...
      <div class="pt-5 pb-5 pl-1 pr-1">
        ...
        <ol class="pl-4">
          ...
          <li class="mb-2">ห้ามทำลิงก์ spam หรือลิงก์ไปสู่เว็บไซต์ลามกอนาจารและสิ่งที่ผิดกฎหมาย ผิดศิลธรรมหากพบเจอการกระทำดังกล่าวจะทำการลบกระทู้แล้วทำการแบนชื่อสมาชิกแบบถาวรทันทีที่พบเจอ</li>
        </ol>
      </div>
  ...
  <?php
  $activePopup = 'resetpass';
  $listResult = ['resetpass'];
