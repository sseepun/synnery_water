...
<body class="loading">
  ...
  <?php 
    $news = [
      [
        ...
        "imgBg" => 'public/assets/app/images/magazine/04.png',
        "title" => 'อธิบดีกรมชลฯ นำทีมผู้บริหาร เข้ารับโล่ เชิดชูเกียรติในงานนิสิตเก่าวิศวกรรมศาสตร์ มก.',
        "desc" => 'เย็นวันนี้ (22  มกราคม 2568) นายสุริยพล นุชอนงค์ อธิบดีกรมชลประทาน พร้อมด้วย นายฐนันดร์  
                      สุทธิพิศาล รองอธิบดีฝ่ายก่อสร้าง และนายวรพจน์ เพชรนรชาติ รองอธิบดีฝ่ายบริหาร 
                      เข้าร่วมงานแสดงความยินดีแด่นิสิตเก่าวิศวกรรมศาสตร์  มหาวิทยาลัยเกษตรศาสตร์ 
        ...
        "imgBg" => 'public/assets/app/images/magazine/05.png',
        "title" => 'อธิบดีกรมชลฯ นำทีมผู้บริหาร เข้ารับโล่ เชิดชูเกียรติในงานนิสิตเก่าวิศวกรรมศาสตร์ มก.',
        "desc" => 'เย็นวันนี้ (22  มกราคม 2568) นายสุริยพล นุชอนงค์ อธิบดีกรมชลประทาน พร้อมด้วย นายฐนันดร์  
                      สุทธิพิศาล รองอธิบดีฝ่ายก่อสร้าง และนายวรพจน์ เพชรนรชาติ รองอธิบดีฝ่ายบริหาร 
                      เข้าร่วมงานแสดงความยินดีแด่นิสิตเก่าวิศวกรรมศาสตร์  มหาวิทยาลัยเกษตรศาสตร์ 
  ...
  <section class="section-padding section-08">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="0">
      <h3 class="color-t text-center fw-700">วารสารแนะนำ</h3>
      <div class="ss-box lg mt-3">
        <div class="swiper">
          <div class="swiper-wrapper">
            <?php foreach($news as $d) {?>
              <div class="swiper-slide">
                <div class="ss-card ss-card-07 type-magazine">
                  <div class="wrapper">
                    ...
                    <div class="text-container">
                      ...
                      <div class="tag bg-p color-white">
                        <p class="sm fw-500">วารสารออนไลน์</p>
                      </div>
    ...
    <?php 
      $content = [
        [
          ...
          "imgBg" => 'public/assets/app/images/magazine/06.png',
          "title" => 'วารสารออนไลน์ นโยบายการกำกับดูแลองค์การที่ดีกรมชลประทาน 2567',
          "cate" => 'วารสารออนไลน์'
        ], [
          "imgBg" => 'public/assets/app/images/magazine/01.png',
    ...
    <section class="section-padding pt-6">
      <div class="container" data-aos="fade-up" data-aos-delay="150">
        ...
        ?>
        <p class="mt-4 mb-2 fw-400">ผลการค้นหา <span class="color-s fw-600">"กรมชลประทาน"</span> ค้นพบ <span class="color-s fw-600">10</span> รายการ</p>
