...
<body class="loading">
  ...
  <section class="section-padding pt-4 bg-white">
    <div class="container">
      ...
      <h6 class="mb-2">ผลการค้นหา <span class="color-p fw-700">"สำนักงาน"</span> ค้นพบ <span class="color-p fw-700">10</span> รายการ</h6>
      ...
      <div class="grids jc-center" data-aos="fade-up" data-aos-delay="150">
        ...
        <?php foreach ($titleMag as $i => $d) { ?>
          <div class="grid lg-1-3">
            <a href="<?= $d['href'] ?>" class="ss-card ss-card-04 bradius-4 box-shadow-unset ovf-hidden h-bg-t">
              ...
              <div class="text-container">
                <div class="wrapper text-center">
                  ...
                  <button class="btn btn-action btn-p bradius-10">
