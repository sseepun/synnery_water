...
<body class="loading">
  ...
  <section class="section-padding pb-0 section-07 bg-gray-07 d-flex ai-center jc-center" style="height: 750px;">
    <h6 class="fw-700 color-gray-08">Singlepage Default</h6>
  </section>
  ...
  <section class="section-padding pt-0">
    <div class="container">
      ...
      <!-- Tag & Share -->
      <div class="d-flex ai-center jc-space-between mt-5 mb-5" data-aos="fade-up" data-aos-delay="500">
        <!-- Tag -->
        <div class="d-flex">
