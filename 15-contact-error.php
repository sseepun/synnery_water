...
<body class="loading">
  ...
  <section class="section-padding section-07">
    <div class="img-bg" style="background-image:url('public/assets/app/images/bg/21-1.jpg'); background-size: contain; background-position: bottom; background-color: #fff;"></div>
    <div class="container">
      <!-- Contact -->
            ...
            <div class="content-wrapper pr-0 bg-right bg-white ovf-visible">
              <form class="form style-02 black-theme" action="action.php">
                <div class="grids">
                  <div class="grid sm-100">
                    ...
                    <div class="form-input">
                      <select class="ui dropdown validate-error">
                        <option value="">กรุณาระบุหัวข้อ</option>
                    ...
                    <p class="xs message-error text-danger mt-1 pl-4">กรุณาระบุหัวข้อ</p>
                  </div>
                  <div class="grid sm-50 mt-2">
                    <label class="fw-400 pl-4">ชื่อ <span class="text-danger">*</span></label>
                    <div class="form-input">
                      <input class="validate-error" type="text" placeholder="กรุณาระบุชื่อ">
                    </div>
                    <p class="xs message-error text-danger mt-1 pl-4">กรุณากรอกชื่อ</p>
                  </div>
                  <div class="grid sm-50 mt-2">
                    <label class="fw-400 pl-4">นามสกุล <span class="text-danger">*</span></label>
                    <div class="form-input">
                      <input class="validate-error" type="text" placeholder="กรุณาระบุนามสกุล">
                    </div>
                    <p class="xs message-error text-danger mt-1 pl-4">กรุณากรอกนามสกุล</p>
                  </div>
                  <div class="grid sm-50 mt-2">
                    <label class="fw-400 pl-4">หมายเลขโทรศัพท์ <span class="text-danger">*</span></label>
                    <div class="form-input">
                      <input class="validate-error" type="text" placeholder="กรุณาระบุหมายเลขโทรศัพท์">
                    </div>
                    <p class="xs message-error text-danger mt-1 pl-4">กรุณากรอกหมายเลขโทรศัพท์</p>
                  </div>
                  <div class="grid sm-50 mt-2">
                    <label class="fw-400 pl-4">อีเมล <span class="text-danger">*</span></label>
                    <div class="form-input">
                      <input class="validate-error" type="text" placeholder="กรุณาระบุอีเมล">
                    </div>
                    <p class="xs message-error text-danger mt-1 pl-4">กรุณากรอกอีเมล</p>
                  </div>
                  <div class="grid sm-100 mt-2">
                    <label class="fw-400 pl-4">รายละเอียด <span class="text-danger">*</span></label>
                    <div class="form-input">
                      <textarea class="validate-error" rows="10" placeholder="กรุณาระบุข้อความ *"></textarea>     
                    </div>
                    <p class="xs message-error text-danger mt-1 pl-4">กรุณากรอกรายละเอียด</p>
                  </div>
                  <div class="grid sm-100 mt-2">
                ...
                <div class="btns ai-center h-full d-flex jc-start sm-jc-center sm-mt-4 mt-5 pt-5">
                  <button class="btn btn-action btn-white-theme md btn-p btn-popup-toggle mr-3 bradius-round" data-popup="86">
                    <p class="color-black-theme">ส่งแบบฟอร์ม</p>          
                  </button> 
                  <div class="btn btn-action btn-white-theme md btn-cancel bradius-round">
