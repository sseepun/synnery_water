        ...
        <div class="grid md-60 sm-100">
          ...
          <form class="form style-02 black-theme" action="action.php">
            <div class="grids">
              <div class="grid sm-50 mt-2">
                ...
                <div class="form-input">
                  <input class="validate-error bradius-10" type="text" placeholder="กรุณาระบุชื่อ">
                </div>
              ...
              <div class="grid sm-50 mt-2">
                ...
                <div class="form-input">
                  <input type="text" class="validate-error bradius-10" placeholder="กรุณาระบุนามสกุล">
                </div>
              ...
              <div class="grid sm-50 mt-2">
                ...
                <div class="form-input">
                  <input type="text" class="validate-error bradius-10" placeholder="กรุณาระบุหมายเลขโทรศัพท์">
                </div>
              ...
              <div class="grid sm-50 mt-2">
                ...
                <div class="form-input">
                  <input class="validate-error bradius-10" type="text" placeholder="กรุณาระบุอีเมล">
                </div>
                <p class="xs message-error text-danger mt-1 pl-4">กรุณากรอกอีเมล</p>
              </div>
              <div class="grid sm-100 mt-2 pb-3">
            ...
            <div class="d-flex fw-wrap jc-space-between ai-center mt-5 pt-5">
              ...
              <p class="fw-200 mobile-order-1">ต้องการยกเลิกรับข่าวสาร ? <a href="#" class="link fw-600">คลิก</a></p>
            </div>
          </form>
        </div>
        <div class="grid md-40 sm-100 text-right">
          <img class="mw-100 bradius-10" src="public/assets/app/images/content/33.jpg" alt="Content">
        </div>
      </div>
  </section>
