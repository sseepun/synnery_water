              ...
              <div class="grids">
                <div class="grid md-25">
                  <label class="upload-container-round mt-4">
                    <img class="preview-img" id="previewImage" src="public/assets/app/images/avatars/01.png" alt="Preview" style="display: block;">
                  ...
                  <div class="grids">
                    <div class="grid sm-50 xs-100 mt-2">
                      ...
                      <div class="form-input mt-2">
                        <input type="text" placeholder="กรุณาระบุชื่อ" value="Narong">
                      </div>
                    </div>
                    <div class="grid sm-50 xs-100 mt-2">
                      <label class="fw-400">นามสกุล</label>
                      <div class="form-input mt-2">
                        <input type="text" placeholder="กรุณาระบุนามสกุล" value="Jaidee">
                      </div>
                    </div>
                    <div class="grid sm-50 xs-100 mt-2">
                      <label class="fw-400">อีเมล</label>
                      <div class="form-input mt-2">
                        <input type="text" placeholder="กรุณาระบุอีเมล" value="mail@joinmail.com">
                      </div>
                    </div>
                    <div class="grid sm-50 xs-100 mt-2">
                      <label class="fw-400">หมายเลขติดต่อ</label>
                      <div class="form-input mt-2">
                        <input type="text" placeholder="กรุณาระบุหมายเลขติดต่อ" value="0903221199">
                      </div>
                    </div>
                    <div class="grid sm-50 xs-100 mt-2">
                      <label class="fw-400">วันเกิด</label>
                      <div class="form-input mt-2">
                        <input type="text" id="#datepicker" class="date-picker form-control datepicker-input" placeholder="กรุณาระบุวันเกิด" value="04/17/2025">
